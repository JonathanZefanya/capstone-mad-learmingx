...
import 'package:laundryku/auth/auth_util.dart';
import 'package:laundryku/backend/backend.dart';
import 'package:laundryku/flutter_flow/flutter_flow_icon_button.dart';
import 'package:laundryku/ongoing_delivered_to_laundry/ongoing_delivered_to_laundry_widget.dart';
...
class AcceptOrderDetailsWidget extends StatefulWidget {
  const AcceptOrderDetailsWidget({required Key key, required this.documentReference}) : super(key: key);
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            await FirebaseFirestore.instance.runTransaction((transaction) async {
                              ...
                              Object? orderData = orderSnapshot.data();
                              String status = orderData != null && (orderData as Map<String, dynamic>).containsKey('customer_order_status') ? orderData['customer_order_status'] : null;
                              // User Reads
                              DocumentReference userRef = UsersRecord.collection.doc(currentUserUid);
                              DocumentSnapshot userSnapshot = await transaction.get(userRef);
                              Object? userData = userSnapshot.data();
                              String acceptedOrder = userData != null && (userData as Map<String, dynamic>).containsKey('accepted_order') ? userData['accepted_order'] : null;

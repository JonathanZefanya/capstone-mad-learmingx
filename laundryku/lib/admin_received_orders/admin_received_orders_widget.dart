...
import 'package:laundryku/components/pickup_confirmation_box_widget.dart';
import 'package:laundryku/received_order_details/received_orders_details_widget.dart';
                                                      ...
                                                      builder: (context) {
                                                        return Padding(
                                                          ...
                                                          child: PickupConfirmationBoxWidget(
                                                            key: Key('pickup_confirmation_${_ordersRecords[index].reference.id}'),
                                                      ...
                                                      builder: (context) {
                                                        return Padding(
                                                          ...
                                                          child: ReceivedConfirmationBoxWidget(
                                                            key: Key('received_confirmation_${_ordersRecords[index].reference.id}'),
                                                            documentReference: _ordersRecords[index].reference,
                                                          ),
                                                        );
                                                      },

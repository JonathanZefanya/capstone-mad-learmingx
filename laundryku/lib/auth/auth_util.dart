  ...
  try {
    ...
    if (userCredential.user != null) {
      ...
      throw FirebaseAuthException(
        ...
        message: 'No user found in userCredential.',
      );
    }
...
bool get currentUserEmailVerified {
  ...
  if (currentUser?.user != null && !(currentUser?.user?.emailVerified ?? true)) {
    currentUser!.user!
        .reload()
...
UsersRecord currentUserDocument = UsersRecord();
...
class AuthUserStreamWidget extends StatelessWidget {
  const AuthUserStreamWidget({required Key key, required this.child}) : super(key: key);

...
class BookingSuccessfulWidget extends StatefulWidget {
  const BookingSuccessfulWidget({required Key key}) : super(key: key);
              ...
              child: InkWell(
                onTap: () async {
                  await Navigator.pushAndRemoveUntil(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          CustomerNavBarPage(key: Key('CustomerMyOrders'), initialPage: 'CustomerMyOrders'),
                    ),
                    (r) => false,
                  );
                },
            ...
            InkWell(
              onTap: () async {
                await Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CustomerNavBarPage(key: Key('Home'), initialPage: 'Home'),
                  ),
                  (r) => false,
                );
              },

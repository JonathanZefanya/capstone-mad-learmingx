...
class CustomerOrderDetailsWidget extends StatefulWidget {
  const CustomerOrderDetailsWidget({Key? key,  this.serviceType, required this.iconData}) : super(key: key);
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    await Navigator.pushAndRemoveUntil(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BookingSuccessfulWidget(key: UniqueKey()),
                      ),
                      (r) => false,
                    );
                  },

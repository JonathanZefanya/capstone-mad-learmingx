...
class PickupOrderDetailsWidget extends StatefulWidget {
  const PickupOrderDetailsWidget({Key? key, required this.documentReference}) : super(key: key);
          ...
          Future.delayed(Duration.zero, () => Navigator.pushAndRemoveUntil(
              ...
              MaterialPageRoute(
                  builder: (context) => OngoingDeliveredToCustomerWidget(
                    documentReference: snapshot.data!.reference as DocumentReference<Object>,
                  )),
                  (route) => route.isFirst));
        }
       return Scaffold(
